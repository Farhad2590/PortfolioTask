    ...
    <div className="min-h-screen bg-[#272c32] py-8 md:py-12 lg:py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        <div className="text-center mb-8 sm:mb-12 md:mb-16">
          ...
          >
            <motion.h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 md:mb-8 text-white">
              Portfolio
            </motion.h1>
            <motion.p
              className="text-white max-w-3xl mx-auto text-sm sm:text-base md:text-lg leading-relaxed"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
